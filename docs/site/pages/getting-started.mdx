...
With Player running your content, you'll need to actually render out what it processes. To do this, you can use the React Player's component API to insert it into your React tree.
